...
public class YambaWallpaper extends WallpaperService {
    ...
    private class YambaWallpaperEngine extends Engine implements Runnable {
        ...
        public YambaWallpaperEngine() {
            yambaclient = new YambaClient("student", "password", "http://yamba.newcircle.com/api");
            paint = new Paint();
...
// enable touch events
        ...
        private void drawFrame() {
            ...
            handler.removeCallbacks(this);
            if (isVisible()) {
                handler.postDelayed(this, 120); // 40 ms = 25 frames per second
            }
        }
